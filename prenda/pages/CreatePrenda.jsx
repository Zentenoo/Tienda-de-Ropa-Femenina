...
import { getModelos } from "../../../src/modelo/helpers/getModelo"
...
export const CreatePrenda = () => {
    ...
    const onSubmit = () => {
        axios.post("http://localhost:5005/prenda", {
                        ...
                        <div class="mb-2">
                            <form onSubmit={onSubmit} action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="intPrecioUnitario" name="intPrecioUnitario" />
                                </div>
                                <div class="mb-3">
