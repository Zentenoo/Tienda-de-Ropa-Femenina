...
export const CreateInventarioPrenda = () => {
    ...
    const onSubmit = () => {
        axios.post("http://localhost:5005/inventarioPrenda", {
        ...
        <div class="container mt-10">
            <section class="d-flex justify-content-center ">
                <div class="card col-sm-6 p-3">
                    <div class="mb-3">
                        <h4>Crear Inventario Prendas</h4>
                    </div>
                    <div class="mb-2">
                        <form onSubmit={onSubmit} action="">
                            ...
                            <div class="d-flex justify-content-center">
                                <Link className="btn btn-primary" onClick={onSubmit} to="/inventarioPrenda">Agregar</Link>
                            </div>
                        </form>
                    </div>
