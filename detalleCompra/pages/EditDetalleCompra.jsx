...
export const EditDetalleCompra = () => {
    ...
    const onSubmit = () => {
        axios.patch(`http://localhost:5005/detalleCompra/${params.id}`, {
                    ...
                    <div class="mb-2">
                        <form onSubmit={onSubmit} action="">
                            ...
                            <div class="d-flex justify-content-center">
                                <Link className="btn btn-primary" onClick={onSubmit} to="/detalleCompra">Editar</Link>
                            </div>
                        </form>
                    </div>
