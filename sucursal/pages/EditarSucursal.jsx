...
export const EditarSucursal = () => {
    ...
    const onSubmit = () => {
        axios.patch(`http://localhost:5005/sucursal/${params.id}`, {
                        ...
                        <div class="mb-2">
                            <form onSubmit={onSubmit} action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id='strEstado' name='strEstado' defaultValue="Activa" class="form-select" >
                                        <option value="Activo">Activa</option>
                                        <option value="Inactivo">Inactiva</option>
                                    </select>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <Link className="btn btn-primary" onClick={onSubmit} to="/sucursal">Editar</Link>
                                </div>
                            </form>
                        </div>
                    </div>
