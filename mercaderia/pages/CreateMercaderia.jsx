...
export const CreateMercaderia = () => {
    const onSubmit = () => {
        axios.post("http://localhost:5005/mercaderia", {
                        ...
                        <div class="mb-2">
                            <form onSubmit={onSubmit} action="">
                                ...
                                <div class="d-flex justify-content-center">
                                    <Link className="btn btn-primary" onClick={onSubmit} to="/mercaderia">Agregar</Link>
                                </div>
                            </form>
                        </div>
                    </div>
