...
export const CreateInventarioAlmacen = () => {
    ...
    console.log(prendas)
    const onSubmit = () => {
        axios.post("http://localhost:5005/inventarioAlmacen", {
            ...
            <div class="container mt-10">
                <section class="d-flex justify-content-center ">
                    <div class="card col-sm-6 p-3">
                        <div class="mb-3">
                            <h4>Agregar Prendas en Almacen</h4>
                        </div>
                        <div class="mb-2">
                            <form onSubmit={onSubmit} action="">
                                ...
                                <div class="d-flex justify-content-center">
                                    <Link className="btn btn-primary" onClick={onSubmit} to="/inventarioAlmacen">Create</Link>
                                </div>
                            </form>
                        </div>
